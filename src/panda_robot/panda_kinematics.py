...
class PandaKinematics(object):
    ...
    def joints_to_kdl(self, type_, values=None, values_pos=None):
    ...
    def forward_velocity_kinematics(self, joint_velocities=None, joint_values=None):
        end_frame = PyKDL.FrameVel()
        self._fk_v_kdl.JntToCart(self.joints_to_kdl('velocities', joint_velocities, joint_values),
                                 end_frame)
